...
mysql_select_db($db);
	 ...
	 for ($i=0; $i < count($finalset_equipment) ; $i++) { 
	 	 ...
	 	 $insert=mysql_query("INSERT INTO equipmentSet VALUES(0,'$setName','$check','$date','$time','$str','$name')");
	 	 echo mysql_error();  
if($insert){
...
$update_status="UPDATE equipment SET `equipment_status`='Assigned' WHERE id='$check'";
